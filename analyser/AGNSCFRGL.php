...
if ($_GET["ACTION"]=="X"){
    ...
    $Query = "SELECT  'TME' AS rfr, csvmfc.fsr as fsr, MAX(csvmfc.tms) AS tgt," .
        ...
        "AND EXTRACT(Month From csvmfc.tms)=EXTRACT(Month From csvrgm.tms) " .
        "GROUP BY csvmfc.fsr ";

    $Query .= " UNION ";

    $Query .= "SELECT  'TMX' AS rfr, csvmfc.fsr as fsr, MAX(csvmfc.tms) AS tgt, " .
        "MAX(csvmfc.ftm) AS ori, " .
    ...
    $Query .= "SELECT  'TMI' AS rfr, csvmfc.fsr as fsr, MAX(csvmfc.tms) AS tgt, " .
        "MAX(csvmfc.ftm) AS ori, " .
    ...
    $Query .= "SELECT  'PRC' AS rfr, csvmfc.fsr as fsr, MAX(csvmfc.tms) AS tgt, " .
        "MAX(csvmfc.ftm) AS ori, " .
